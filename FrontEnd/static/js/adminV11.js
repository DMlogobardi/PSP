...
const tabella = async(richiesta,list=[])=> {
	...
	let stringaEliminaSelezionati = richiesta.toLowerCase() !== 'entris' ? `<button type="button" class="btn btn-sm btn-primary" onClick="elimina(0,'${richiesta}');">ELIMINA SELEZIONATI</button>`: ""; 
	let stringaTabella = `
